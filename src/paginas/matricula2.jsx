...
import logo from '../assets/PE.png'; // Importa el logo
...
function Matricula2() {
  ...
  const handleSubmit = (e) => {
    e.preventDefault();
    navigate('/puceexamen'); // Redirige a la página de examen
  };
  ...
  return (
    <div className="form-container">
      ...
      <div className="commitments">
        <p className="parrafo">
          He sido informado y estoy conforme con las siguientes condiciones y compromisos previos a la matriculación:
        </p>
        <ol>
      ...
      <form onSubmit={handleSubmit}>
        ...
        <div className="button-group">
          <button type="submit">Continuar Admisión</button>
        </div>
      </form>
    </div>
  );
